      ...
      <div className="w-full max-w-4xl m-auto md:flex bg-white border-black border-2 rounded-lg ">
        <div className="max-w-sm  overflow-hidden w-full p-5 ">
          <img
            ...
            className="hover:scale-125 transition-all h-full mix-blend-multiply"
            alt=""
          />
        </div>
        <div className="flex flex-col gap-2 p-5">
          ...
          <div className="flex gap-3">
            <button
              onClick={handleBuy}
              className="bg-green-800 text-white py-1 mt-2 rounded hover:bg-purple-700 min-w-[100px]"
            >
              Buy
            </button>
            <button
              onClick={handleAddCartProduct}
              className="bg-green-500 py-1 mt-2 hover:bg-purple-700 text-white min-w-[120px] rounded-lg"
            >
              Add to Basket
            </button>
          </div>
